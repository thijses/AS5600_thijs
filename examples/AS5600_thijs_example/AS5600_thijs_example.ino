...
AS5600_thijs sensor; //on the atmega328p it's a nearly static class, i think i can make the code run faster (eliminate stack setup time like inline functions) by changing the class structure
